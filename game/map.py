...
class Map:
    ...
    def generate_basic_map(self):
        ...
        self.map = [
            ...
            ['W', ' ', 'W', ' ', 'W', 'W', 'W', ' ', ' ', 'X', 'W', 'W', 'W', ' ', ' ', 'W', ' ', ' ', 'W', 'Z', ' ', 'W', 'W', ' ', ' ', 'W', 'Z', 'W'],
            ['W', ' ', ' ', ' ', 'W', ' ', ' ', ' ', 'W', 'W', ' ', 'W', 'W', ' ', 'W', ' ', 'W', 'W', ' ', ' ', 'W', ' ', ' ', 'W', ' ', 'W', ' ', 'W'],
            ['W', ' ', 'W', ' ', 'W', 'Y', 'W', ' ', ' ', 'X', ' ', ' ', 'W', ' ', 'W', ' ', ' ', 'Y', 'W', ' ', 'X', 'W', 'W', ' ', 'W', 'W', 'X', 'W'],
            ['W', 'W', 'W', ' ', 'W', 'W', ' ', ' ', 'W', 'W', 'W', ' ', 'W', ' ', ' ', ' ', 'W', 'W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'W', 'X', 'W'],
            ['W', 'Y', 'W', ' ', 'X', ' ', ' ', ' ', 'W', 'Y', 'W', ' ', ' ', 'X', 'W', ' ', 'W', ' ', 'W', 'W', ' ', 'W', 'W', ' ', ' ', 'W', 'X', 'W'],
            ['W', ' ', 'W', 'W', ' ', 'W', ' ', 'W', 'W', ' ', 'W', 'W', 'W', 'W', ' ', 'W', ' ', 'W', ' ', 'W', ' ', ' ', ' ', 'W', ' ', 'W', 'X', 'W'],
            ['W', ' ', 'Y', 'W', ' ', 'W', ' ', 'W', 'Y', ' ', ' ', 'W', 'Z', 'W', 'W', ' ', ' ', ' ', ' ', ' ', ' ', 'W', 'Y', 'W', ' ', 'W', ' ', 'W'],
            ['W', 'X', ' ', ' ', ' ', 'W', 'X', ' ', ' ', ' ', ' ', 'W', ' ', 'Y', 'W', 'W', 'W', 'W', ' ', 'W', ' ', 'W', 'W', 'W', ' ', 'W', 'Y', 'W'],
            ['W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', ' ', 'W', ' ', ' ', ' ', 'W', ' ', 'Y', 'W', 'W', 'X', 'Y', ' ', 'W', 'Y', 'W'],
            ['W', 'Y', 'W', ' ', 'W', 'Y', 'Y', 'W', ' ', 'W', ' ', 'W', ' ', 'W', ' ', ' ', ' ', ' ', 'W', 'W', ' ', ' ', 'W', 'W', ' ', 'W', 'Y', 'W'],
            ['W', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', 'W', ' ', 'W', ' ', ' ', 'W', ' ', 'W', ' ', ' ', ' ', ' ', 'W', ' ', ' ', ' ', 'W', ' ', 'W'],
            ['W', ' ', 'W', 'W', 'W', 'W', ' ', ' ', 'W', 'W', 'Z', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', 'W', ' ', ' ', ' ', 'W', 'Z', 'W', ' ', 'W'],
            ['W', ' ', ' ', 'Y', ' ', 'W', ' ', 'W', 'W', ' ', 'Y', 'W', 'W', 'W', ' ', ' ', ' ', ' ', 'W', ' ', 'W', 'W', ' ', ' ', 'W', 'W', ' ', 'W'],
            ['W', ' ', 'W', 'W', 'X', 'W', ' ', 'W', ' ', ' ', ' ', 'W', ' ', 'X', 'W', ' ', 'W', 'W', ' ', ' ', ' ', 'W', 'W', 'W', 'X', 'W', ' ', 'W'],
            ['W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', 'W', ' ', 'Y', ' ', ' ', 'W', ' ', 'W'],
            ['W', 'W', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Z', ' ', 'W', 'W', ' ', 'W', 'W', 'Y', 'W', ' ', 'W'],
            ['W', ' ', ' ', 'W', ' ', 'W', ' ', 'W', 'W', ' ', ' ', 'W', ' ', 'W', ' ', 'W', ' ', ' ', 'W', 'W', ' ', ' ', 'Y', ' ', ' ', 'W', ' ', 'W'],
            ['W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'X', ' ', ' ', ' ', ' ', ' ', 'X', ' ', ' ', ' ', ' ', ' ', 'W', ' ', 'W', 'W', 'W', ' ', 'W'],
            ['W', ' ', 'Z', ' ', ' ', ' ', 'W', 'X', ' ', ' ', ' ', ' ', 'Z', ' ', ' ', ' ', 'W', 'Z', ' ', ' ', 'W', ' ', 'Z', ' ', ' ', ' ', 'Y', 'W'],
            ['W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W'],
        ]
