...
class Map:
    ...
    def generate_basic_map(self):
        ...
        self.map = [
            ...
            ['W', ' ', 'W', ' ', 'W', 'Y', ' ', ' ', 'W', ' ', 'Y', 'X', 'W', ' ', ' ', 'X', ' ', ' ', ' ', ' ', ' ', ' ', 'Y', 'W', 'X', 'W', ' ', 'W'],
            ['W', ' ', 'W', ' ', 'W', 'W', 'W', ' ', ' ', 'X', 'W', 'W', 'W', ' ', ' ', 'W', ' ', ' ', 'W', ' ', 'X', 'W', 'W', 'W', ' ', 'W', 'Z', 'W'],
            ['W', ' ', ' ', ' ', 'W', 'X', ' ', ' ', 'W', 'W', ' ', 'W', 'W', ' ', 'W', ' ', 'W', 'W', ' ', 'Z', 'W', 'W', 'X', ' ', ' ', 'W', ' ', 'W'],
            ['W', ' ', 'W', ' ', 'W', ' ', 'W', ' ', ' ', 'X', ' ', ' ', 'W', ' ', 'W', ' ', 'Y', 'X', 'W', ' ', 'X', 'W', 'W', ' ', 'W', 'W', 'Z', 'W'],
            ['W', 'W', 'W', ' ', 'W', 'W', ' ', ' ', 'W', 'W', 'W', ' ', 'W', ' ', ' ', 'X', 'W', 'W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'W', 'X', 'W'],
            ['W', 'Y', 'W', ' ', ' ', ' ', ' ', ' ', 'W', 'X', 'W', ' ', ' ', 'X', 'W', ' ', 'X', ' ', 'W', 'W', ' ', 'W', 'W', ' ', ' ', 'W', 'X', 'W'],
            ['W', ' ', 'W', 'W', ' ', 'W', ' ', 'W', 'W', ' ', 'W', 'W', 'W', 'W', ' ', 'W', ' ', 'W', ' ', 'W', ' ', ' ', ' ', 'W', ' ', 'W', 'X', 'W'],
            ['W', ' ', 'Y', 'W', 'X', 'W', ' ', 'W', 'Y', ' ', ' ', 'W', 'Z', 'W', 'W', ' ', ' ', ' ', 'Y', ' ', ' ', 'W', 'Y', 'W', ' ', 'W', ' ', 'W'],
            ['W', 'X', ' ', ' ', ' ', 'W', 'X', ' ', ' ', ' ', ' ', 'W', ' ', 'Y', 'W', 'W', 'W', 'W', ' ', 'W', ' ', ' ', ' ', 'W', ' ', 'W', 'Y', 'W'],
            ['W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', ' ', 'W', 'W', ' ', ' ', 'W', 'X', 'W', 'W', 'W', 'X', 'Y', ' ', 'W', 'Y', 'W'],
            ['W', 'Y', 'W', ' ', 'W', 'Y', 'Y', ' ', ' ', 'W', ' ', 'W', ' ', 'W', ' ', ' ', ' ', 'W', 'W', 'W', ' ', 'W', 'W', 'W', ' ', 'W', 'Y', 'W'],
            ['W', ' ', ' ', ' ', ' ', ' ', 'X', ' ', 'X', ' ', ' ', 'W', ' ', 'W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'W', ' ', 'W'],
            ['W', ' ', 'W', 'W', 'W', 'W', ' ', ' ', 'W', 'W', 'Z', ' ', ' ', ' ', ' ', ' ', 'W', ' ', 'W', 'W', 'W', ' ', ' ', 'W', 'Z', 'W', ' ', 'W'],
            ['W', ' ', ' ', 'Y', ' ', 'W', ' ', 'W', 'W', ' ', 'Y', 'W', 'W', 'W', ' ', ' ', ' ', ' ', ' ', ' ', 'W', 'W', ' ', ' ', 'W', 'W', 'Z', 'W'],
            ['W', ' ', 'W', 'W', 'X', 'W', ' ', 'W', ' ', ' ', ' ', 'W', ' ', 'X', 'W', ' ', 'W', 'W', 'W', ' ', 'W', 'W', 'W', 'W', 'W', 'W', ' ', 'W'],
            ['W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', 'W', ' ', 'Y', ' ', 'X', 'W', ' ', 'W'],
            ['W', 'W', ' ', ' ', ' ', ' ', ' ', 'W', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', 'Z', ' ', 'W', 'W', ' ', 'W', 'W', 'Y', 'W', ' ', 'W'],
            ['W', ' ', ' ', 'W', ' ', 'W', ' ', 'W', 'W', ' ', ' ', 'W', ' ', 'W', ' ', 'W', ' ', ' ', 'W', 'W', ' ', ' ', 'Y', ' ', ' ', 'W', ' ', 'W'],
            ['W', 'X', 'W', 'W', ' ', ' ', ' ', ' ', ' ', 'X', ' ', ' ', ' ', ' ', ' ', 'X', ' ', ' ', ' ', ' ', ' ', 'W', ' ', 'W', 'W', 'W', ' ', 'W'],
            ['W', ' ', 'Z', ' ', ' ', ' ', 'W', 'X', ' ', ' ', ' ', ' ', 'Z', ' ', ' ', ' ', 'W', 'Z', 'W', 'Y', ' ', ' ', 'Z', ' ', ' ', ' ', 'Y', 'W'],
            ['W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W'],
        ]
